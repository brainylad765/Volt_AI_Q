      ...
      body: alerts.isEmpty
          ...
          : ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                final config = _getConfig(alert.type);  // ✅ Pass string directly, not .name
                return ListTile(
                  leading: Container(
                    width: 40,
                    height: 40,
                  ...
                  title: Text(
                    alert.title,
                    style: TextStyle(fontWeight: alert.read ? FontWeight.normal : FontWeight.bold),
                  ),
                  subtitle: Column(
                    ...
                    children: [
                      ...
                      Text(
                        alert.time,  // ✅ Just show the string, don't parse hour/minute
